...
const KCUFEPSOPage = () => {
  return (
    <div className="container mx-auto px-4 py-12">
      ...
      <p className="mb-4">🌐 Event website: <a href="https://www.eujobs.co/KCUFEPSO" className="text-blue-600 hover:underline">https://www.eujobs.co/KCUFEPSO</a></p>
      <p className="mb-4">📩 Contact: <a href="mailto:chaollapark@gmail.com" className="text-blue-600 hover:underline">chaollapark@gmail.com</a></p>
